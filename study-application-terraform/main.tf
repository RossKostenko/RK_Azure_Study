...
resource "azurerm_windows_function_app" "products_service" {
  name     = "rkg-fa-products-service-ne-001"
  location = "northeurope"
...
resource "azurerm_windows_function_app_slot" "products_service_dev" {
  name               = "psn-development"
